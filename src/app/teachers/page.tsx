...
import { getVerifiedTeachers, getTeacherDisplayName, parseSubjects, parseLanguages, formatRating, getTeacherInitials } from '@/lib/api/teachers';
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-3">
                      <div className="w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 text-white font-bold text-sm flex items-center justify-center shrink-0">
                        {profilePic ? (
                          <Image
                            src={profilePic}
                            alt={name}
                    ...
                    {subjects.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mb-3">
                        {subjects.slice(0, 4).map((subj: string) => (
